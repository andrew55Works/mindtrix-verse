...
import { WaterShader2D } from '../3d/lib/water-shader-2d/water-shader-2d';
...
export default class ViennaWoodsScene {
  ...
  public async initScene() {
    ...
    this.renderer.setClearColor(0x000000, 0); // transparent: set background alpha to 0
    ...
    // const lightHelper1 = new THREE.DirectionalLightHelper(this.light1);
    // this.scene.add(lightHelper1);
    // this.light1.visible = true;
    // lightHelper1.visible = true;

    this.light2.castShadow = true;
    this.light2.position.set(-6, 5, 10);
    this.scene.add(this.light2);

    // const lightHelper2 = new THREE.PointLightHelper(this.light2);
    ...
    // const lightHelper3 = new THREE.PointLightHelper(this.light3);
    // this.scene.add(lightHelper3);
    // this.light3.visible = true;
    // lightHelper3.visible = true;

    // add water
    // const flowMapTexture = new THREE.TextureLoader();
    ...
    // flowMapTexture.load(
    //   // '/img/world/vienna_woods/FloorsCheckerboard_S_Diffuse.jpg',
    //   '/img/world/vienna_woods/river_heightmap.jpg',
    //   (map) => {
    ...
    // water ground
    // const waterRiverGeometry = new THREE.PlaneGeometry(18.8, 18.8);
    // const flowMap = flowMapTexture.load(
    //   //'/img/world/vienna_woods/Water_1_M_Flow.jpg',
    //   '/img/world/vienna_woods/river_flowmap.jpg',
    // );
    // const waterRiver = new Water(waterRiverGeometry, {
    //   flowMap,
    // });
    // waterRiver.position.y = 0;
    // waterRiver.rotation.x = Math.PI * -0.5;
    // this.scene.add(waterRiver);
    //
    // // waterfall
    // const waterFallGeometry = new THREE.PlaneGeometry(0.8, 6.8);
    // const waterFall = new Water(waterFallGeometry, {
    //   flowMap,
    // });
    //
    // waterFall.position.x = -5.2;
    // waterFall.position.y = 1.26;
    // waterFall.position.z = -4.25;
    // this.scene.add(waterFall);
    //
    // // waterSkyLake
    // const waterSkyLakeGeometry = new THREE.PlaneGeometry(1, 3);
    // const waterSkyLake = new Water(waterSkyLakeGeometry, {
    //   scale: 1,
    //   textureWidth: 512,
    //   textureHeight: 512,
    //   flowMap,
    // });
    // waterSkyLake.rotation.x = Math.PI * -0.5;
    //
    // waterSkyLake.position.x = -5.2;
    // waterSkyLake.position.y = 1.26;
    // waterSkyLake.position.z = -4.25;
    // this.scene.add(waterSkyLake);
    ...
    // console.info('set river:', name);

    const gltfLoader = new GLTFLoader(this.loadingManager);

    const worldGltf = '/3d/world/world_vienna_woods_v13.gltf';
    ...
    gltfLoader.load(worldGltf, (gltfScene) => {
      gltfScene.scene.traverse((c) => {
        ...
        if (isLandmarkButton) {
          // console.info('hover_button_name:', name);
      ...
      // console.info('gltfScene.scene.animations:', this.clips);
    });
  ...
  public playLandingAnimation = (
    ...
    // const green_bazaar_clip = THREE.AnimationClip.findByName(
    //   this.clips,
    //   'landing_green_bazaar',
    // );
    // const green_bazaar_action = this.mixer.clipAction(green_bazaar_clip);
    // green_bazaar_action?.setLoop(THREE.LoopOnce, 1);
    // green_bazaar_action?.play();
  };
