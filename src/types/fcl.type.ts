...
declare module '@onflow/fcl' {
  ...
  interface VerifyParams {
    address: string;
    nonce: string;
    signatures: Array<CompositeSignature>;
  }
  ...
  export namespace AppUtils {
    ...
    export function verifyUserSignatures(
      message: string,
      compositeSignatures: Array<CompositeSignatures>,
    ): Promise<boolean>;
  ...
  export namespace currentUser {
    ...
    function signUserMessage(
      message: string,
    ): Promise<Array<CompositeSignature>>;
  }
  ...
  export namespace discovery {
    ...
    namespace authn {
       ...
       */
      function snapshot(): Promise<Array<WalletService>>;
      ...
      function subscribe(
        callback: (res: { results: Array<WalletService> }) => void,
      ): void;
    }
  }
   ...
   */
  export function send(builders: Array<Builders>): Promise<ResponseObject>;
   ...
   */
  export function args(args: Array<ArgumentObject>): Partial<Interaction>;
  ...
  export type BlockObject = BlockHeaderObject & {
     ...
     */
    blockSeals: Array<SealedBlockObject>;
    /**
     * Contains the ids of collections included in the block.
     */
    collectionGuarantees: Array<CollectionGuaranteeObject>;
    /**
     * All signatures.
     */
  ...
  export interface CollectionGuaranteeObject {
     ...
     * All signatures.
     */
    signatures: Array<SignableObject>;
  }
