...
transaction(
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&Mindtrix.Collection>(from: Mindtrix.MindtrixCollectionStoragePath) == nil {
            buyer.save(<-Mindtrix.createEmptyCollection(), to: Mindtrix.MindtrixCollectionStoragePath)
            buyer.link<&{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, Mindtrix.MindtrixCollectionPublic, MetadataViews.ResolverCollection}>(
