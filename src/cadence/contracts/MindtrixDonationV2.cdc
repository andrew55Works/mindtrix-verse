...
pub contract MindtrixDonationV2 {
    ...
    pub fun mintNFTFromDonation(
        ...
        let mindtrixTreasuryAddress: Address = MindtrixDonationV2.account.address
        let essenceMetadata = essenceStruct.getMetadata()
        let showGuid = essenceMetadata["showGuid"] ?? ""
        let mintPrice = payment.balance

        let royaltiesFromShowGuid = MindtrixDonationV2.showGuidToRoyalties[showGuid] !as {String: [MetadataViews.Royalty]}
